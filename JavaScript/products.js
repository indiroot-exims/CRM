// ===========================================================
// 📦 PRODUCTS MANAGEMENT - INDIROOT EXIMS (v3 Compatible)
// ===========================================================
...
async function submitProduct(isUpdate) {
  ...
  formData.append("action", isUpdate ? "updateProduct" : "addProduct");
...
function displayProducts(data) {
  ...
  data.forEach((row, idx) => {
    ...
    row.forEach((cell, colIdx) => {
      ...
      td.textContent = colIdx === 4 ? formatDateDisplay(cell) : cell;
      tr.appendChild(td);
    });
...
window.editProduct = function (idx) {
  ...
  if (!rowData) return alert("Invalid product selection.");
